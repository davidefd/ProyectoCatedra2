...
document.getElementById('form_energia').addEventListener('submit', function (e) {

	var pago = parseFloat(document.getElementById('energia').value);
	...
	e.preventDefault();
	document.getElementById('form_energia').reset();
});

//Función para pagar factura de luz y guardarlo en localStorage.
function pagarLuz(item) {
...
function crearPDF(item){
	...
	doc.setFontSize(22);
	doc.text("Pago de luz: " + "$" + tPago, 10, 70);
