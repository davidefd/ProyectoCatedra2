...
document.getElementById('form_phone').addEventListener('submit', function(e){

	var pago = parseFloat(document.getElementById('phone').value);
	...
	e.preventDefault();
	document.getElementById('form_phone').reset();
});

//Función para pagar factura de teléfono y guardarlo en localStorage.
function pagarTelefono(item){
...
function crearPDF(item){
	...
	doc.setFontSize(22);
	doc.text("Pago de teléfono: " + "$" + tPago, 10, 70);
