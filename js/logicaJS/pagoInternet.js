...
document.getElementById('form_internet').addEventListener('submit', function(e){

	var pago = parseFloat(document.getElementById('internet').value);
	...
	e.preventDefault();
	document.getElementById('form_internet').reset();
});

//Función para pagar factura de internet y guardarlo en localStorage.
function pagarInternet(item){
...
function crearPDF(item){
	...
	doc.setFontSize(22);
	doc.text("Pago de internet: " + "$" + tPago, 10, 70);
